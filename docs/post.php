...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top">
    	...
    	<ul class="navbar-nav ml-auto align-items-center">
    		...
    		<div class="dropdown-menu dropdown-menu-right shadow-lg" aria-labelledby="dropdown02">
    			<h4 class="dropdown-header display-4">Download Image</h4>
    ...
    <div class="container">
    	<div class="row justify-content-center">
    		<div class="col-md-7">
    			<article class="card">
    			<img class="card-img-top mb-2" src="https://i0.wp.com/wipy.tv/wp-content/uploads/2020/02/Actrices-que-podri%CC%81an-ser-Rapunzel-1.jpg?fit=1000%2C600&ssl=1" alt="Card image">
    			<div class="card-body">
